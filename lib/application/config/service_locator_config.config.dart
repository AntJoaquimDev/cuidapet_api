...
import '../../modules/categories/controller/categories_controllr.dart' as _i17;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i6.IUserRepository>(() => _i7.UserRpositoryImpl(
  ...
  gh.lazySingleton<_i15.ICategoriesService>(() => _i16.CategoriesServiceImpl(
      repository: get<_i13.ICategoriesRepository>()));
  gh.factory<_i17.CategoriesControllr>(
      () => _i17.CategoriesControllr(service: get<_i15.ICategoriesService>()));
  return get;
}
