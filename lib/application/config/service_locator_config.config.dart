...
import '../../modules/categories/controller/categories_controllr.dart' as _i32;
import '../../modules/categories/data/categories_repository_impl.dart' as _i22;
...
import '../../modules/supplier/service/i_supplier_service_impl.dart' as _i30;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i21.ICategoriesRepository>(
      () => _i22.CategoriesRepositoryImpl(
            connection: get<_i3.IDatabaseConnection>(),
            log: get<_i8.ILogger>(),
          ));
  gh.lazySingleton<_i23.ICategoriesService>(() => _i24.CategoriesServiceImpl(
      repository: get<_i21.ICategoriesRepository>()));
  ...
  gh.factory<_i32.CategoriesControllr>(
      () => _i32.CategoriesControllr(service: get<_i23.ICategoriesService>()));
